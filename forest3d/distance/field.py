"""Distance-field generators for coregistration workflows.

The classes defined in this module are considered "cold path" utilities and utilize
Numpy/Scipy implementations of business logic. These are intended to be precomputed
as inputs to "hot path" utilities that are implemented in JAX and can be used inside
`jax.jit`-compiled functions during optimization workflows.
"""
...
class DistanceField:
    ...
    def from_surface(
        ...
        *,
        ...
        # euclidean distance in coordinate units using voxel spacings.
